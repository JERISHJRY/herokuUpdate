          ...
          <Carousel>
            <Carousel.Item data-interval="2000">
              <div className="item active">
                ...
                <div className="col-sm-4">
                  <img src={girl1} className="girl img-responsive mt-5 " alt="" />
                  <img
            ...
            <Carousel.Item interval={500}>
              <div className="item active">
                ...
                <div className="col-sm-2"></div>
                <div className="col-sm-4">
                  <img src={girl2} className="girl img-responsive mt-5 " alt="" />
                  <img
                    src="images/home/pricing.png"
                    className="pricing"
                    alt=""
            ...
            <Carousel.Item interval={500}>
              <div className="item active">
                ...
                <div className="col-sm-4 text-center">
                  <img src={girl3} className="girl img-responsive mt-5 " alt="" />
                  <img
                    src="images/home/pricing.png"
                    className="pricing"
                    alt=""
