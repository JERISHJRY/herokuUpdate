...
const AddWishlistButton = (props) => {
  ...
  const wishList = useSelector((state) => state.WishlistReducer.addtowishlist);
    ...
    <>
      {fav === false && (
        <button
          ...
          onClick={(e) => {
            dispatch(addToWishlist(wishListItems, product), setfav(true));
          }}
        >
      ...
      {fav === true && (
        <button
          className="add_wishlist"
          onClick={(e) => {
            dispatch(RemoveFromWishlist(wishListItems, product), setfav(false));
          }}
        >
